# Healtify — Gift Redemption REST API
...
- `UsersService` — create with bcrypt, conflict handling, not-found.
...
```json
{ "errors": [ { "status": "400", "title": "BadRequestException", "detail": "...", "source": { "pointer": "/api/..." } } ] }
```
